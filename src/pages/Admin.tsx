...
import { 
  ...
  Calendar, GraduationCap, BookOpen, Star, Settings, Send, Briefcase
} from "lucide-react";
      ...
      <main className="container py-8">
        ...
        <Tabs defaultValue="content" className="space-y-6">
          <TabsList className="flex flex-wrap gap-2 h-auto p-2">
            ...
            <TabsTrigger value="careers" className="flex items-center gap-2 py-2 px-3">
              <Briefcase className="w-4 h-4" /><span className="hidden sm:inline">Careers</span>
            </TabsTrigger>
          ...
          <TabsContent value="careers">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2"><Briefcase className="w-5 h-5" />Career Opportunities</CardTitle>
                <CardDescription>Manage job openings and career opportunities</CardDescription>
              </CardHeader>
              <CardContent><CareersManager /></CardContent>
            </Card>
          </TabsContent>

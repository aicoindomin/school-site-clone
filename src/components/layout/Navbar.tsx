            ...
            <Link to="/" className="flex items-center gap-5 group">
              ...
              <div className="relative">
                ...
                <img 
                  ...
                  className="relative w-20 h-20 md:w-24 md:h-24 rounded-full bg-white p-1 shadow-2xl group-hover:scale-105 transition-transform duration-500 ring-2 ring-cyan-400/40" 
                />
              </div>
